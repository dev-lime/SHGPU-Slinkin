...
Расширить полученную иерархию классом хранилища в нетипированном файле данных любых типов с прямым доступом по индексу. Разработать класс для хранения целочисленных данных в файле. Общая структура иерархии:
 TAbstractStorage ─➤ TMemStorage ─➤ TIntMemStorage
        │                 ╰───────➤ TFloatMemStorage
